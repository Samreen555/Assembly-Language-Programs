;5. Write instructions that use direct-offset addressing to move the four values in Uarray to the 
;EAX, EBX, ECX, and EDX registers. When you follow this with a call DumpRegs statement, the 
;following register values should display:
;Uarray WORD 1000h, 2000h, 3000h,4000h
;Write program for each statement in assembly languages
.model small
.stack 100h
.data
